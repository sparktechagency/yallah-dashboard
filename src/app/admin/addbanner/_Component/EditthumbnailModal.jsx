...
import { useUpdatethumbnailsMutation } from "@/redux/api/thumbnailApi";

const EditthumbnailModal = ({ open, setOpen, selectedBanner }) => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (res?.success) {
        toast.success(res?.message || "Thumbnail updated successfully");
        form.resetFields();
        setOpen(false);
      }
    } catch (error) {
